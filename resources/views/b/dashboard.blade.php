                                ...
                                <li class="nav-item hidden-on-mobile">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-end language-dropdown"
                                        ...
                                        <li><a class="dropdown-item" href="#"><img
                                                    src="{{ asset('b/images/flags/germany.png') }}" alt="">German</a>
                                        </li>
                                        <li><a class="dropdown-item" href="#"><img
                                                    src="{{ asset('b/images/flags/italy.png') }}" alt="">Italian</a>
                                        </li>
                                        <li><a class="dropdown-item" href="#"><img
                ...
                <div class="content-wrapper">
                    <div class="container">
                                        ...
                                        <div class="widget-payment-request-container">
                                            <div class="widget-payment-request-author">
                                                <div class="avatar m-r-sm">
                                                    <img src="{{ asset('b/images/avatars/avatar.png') }}" alt="">
                                                </div>
                                            ...
                                            <div class="widget-payment-request-product">
                                                <div class="widget-payment-request-product-image m-r-sm">
                                                    <img src="{{ asset('b/images/other/facebook_logo.png') }}"
                                                        class="mt-auto" alt="">
                                                </div>
                                    ...
                                    <div class="card-body">
                                        <div class="widget-popular-product-container">
                                            <div class="widget-popular-product-image">
                                                <img src="{{ asset('b/images/widgets/popular-product.jpeg') }}"
                                                    alt="">
                                            </div>
                        ...
                        <div class="row">
                            <div class="col-xl-4">
                                <div class="card">
                                    <img src="{{ asset('b/images/widgets/blog5.jpeg') }}" class="card-img-top"
                                        alt="...">
                                    <div class="card-body">
                                    ...
                                    <div class="card-body">
                                        <div class="widget-popular-blog-container">
                                            <div class="widget-popular-blog-image">
                                                <img src="{{ asset('b/images/widgets/product2.jpeg') }}" alt="">
                                            </div>
